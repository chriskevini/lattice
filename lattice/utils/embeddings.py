...
class EmbeddingModel:
    ...
    def load(self) -> None:
        ...
        # Load model with CPU optimization for 2GB RAM constraint
        self._model = SentenceTransformer(
            self.model_name,
            cache_folder=str(self.cache_dir),
            device="cpu",  # Optimized for constrained environment
        )
    ...
    def encode(self, texts: str | list[str]) -> np.ndarray:
        ...
        # Encode with optimized batch size for memory constraints
